...
for ((tp=0;tp<${#TP[@]};tp++))
do
echo "cp ${PathID}/${PN}_*${TP[tp]}/* ${PathScratch}/." >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/Results/* ${PathScratch}/." >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/Priors/* ${PathScratch}/." >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/Brainmask/* ${PathScratch}/." >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/* ${PathScratch}/." >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/*prior* ${PathScratch}/GIF_${PN}_${TP[tp]}_prior.nii.gz" >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/*Segmentation* ${PathScratch}/GIF_${PN}_${TP[tp]}_Segmentation.nii.gz" >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/*Parcellation* ${PathScratch}/GIF_${PN}_${TP[tp]}_Parcellation.nii.gz" >> ${NameScript}
echo "cp ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/*TIV* ${PathScratch}/GIF_${PN}_${TP[tp]}_TIV.nii.gz" >> ${NameScript}
echo "${PathSeg}/seg_maths ${PathID}/${PN}_*${TP[tp]}/${PathGIF}/*TIV* -odt char ${PathScratch}/${PN}_${TP[tp]}_B1.nii.gz" >> ${NameScript}
done
echo "cp ${PathID}/${PN}_*${OptTP}/${PathGIF}/* ${PathScratch}/." >> ${NameScript}
...
# summing to obtain CSFs and GM
	...
	echo " ${PathSeg}/seg_maths ${PathScratch}/GIF_DGM_${PN}_${TP[tp]}.nii.gz -sub ${PathScratch}/GIF_DGM_${PN}_${TP[tp]}_corr.nii.gz -thr 0 -add ${PathScratch}/GIF_WMI_${PN}_${TP[tp]}.nii.gz ${PathScratch}/GIF_WMI_${PN}_${TP[tp]}.nii.gz" >> ${NameScript}
        ...
        if [ -f ${PathID}/${PN}_${TP[tp]}/Priors/GIF_GM_${PN}_${TP[tp]}.nii.gz ] || [ -f ${PathID}/${PN}_${TP[tp]}/${PathGIF}/*prior* ]
        then
...
#101 102 139 140 187 188 169 170
    if [ ! -f ${PathID}/${PN}_${TP[tp]}/Priors/${PN}_${TP[tp]}_Artefacts.nii.gz ]
    then
        if ((${#ArtefactArray[@]}>0))
        then
            ...
            do
                ...
                echo "${PathSeg}/seg_maths ${PathScratch}/${PN}_${TP[tp]}_Parcellation.nii.gz -thr $ValueMin -uthr $ValueMax -bin ${PathScratch}/${PN}_${TP[tp]}_ArtConstruction_${i}.nii.gz " >> ${NameScript}
            ...
            echo "cp ${PathScratch}/${PN}_${TP[tp]}_Artefacts.nii.gz ${PathID}/${PN}_${TP[tp]}/Priors/." >> ${NameScript}
        fi
    fi
fi
        ...
        do
            ...
            array_priorspre=()
                ...
                do
                    ...
                    then
                        echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}.nii.gz -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
                    fi
    ...
    do
        ...
        then
            ...
            do
                ...
                then
                    echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/ICBM*_${p}_${PN}_${TP[tp]}* -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
                fi
                array_priorspre=(${array_priorspre[*]} "${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz")
            done
...
# then
#  echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/GIF*_${p}_*${PN}_${TP[tp]}* -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/GIF_${p}_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
# fi
...
#   then
#    echo "${PathReg}/reg_resample -ref ${PathID}/${PN}_GW${OptTP}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathID}/${PN}_${TP[tp]}/Brainmask/*B1* -cpp  ${PathID}/${PN}_GW${OptTP}/Reg/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathID}/${PN}_GW${OptTP}/Brainmask/${PN}_${TP[tp]}_preB1.nii.gz" >> ${NameScript}
    ...
    do
        ...
        then
            ...
            do
                if [ ! -f ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz ]
                then
                    echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/GIF*_${p}_${PN}_${TP[tp]}.nii.gz -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/GIF_${p}_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
                fi
                array_priorspre=(${array_priorspre[*]} "${PathScratch}/GIF_${p}_${PN}_${TP[tp]}_preGW.nii.gz")
            done
...
# Mean over the transformed time points
    ...
    do
        ...
        then
            ...
            echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/${PN}_${TP[tp]}_GIF_B1.nii.gz -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/GIF_B1_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
        fi
    ...
    do
        ...
        then
            ...
            do
                if [ ! -f ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz ]
                then
                    echo "${PathReg}/reg_resample -ref ${PathScratch}/T1_${PN}_GW${OptTP}.nii.gz -flo  ${PathScratch}/ICBM*_${p}_${PN}_${TP[tp]}.nii.gz -cpp  ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2.nii.gz -res ${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz" >> ${NameScript}
                fi
                array_priorspre=(${array_priorspre[*]} "${PathScratch}/ICBM_${p}_${PN}_${TP[tp]}_preGW.nii.gz")
            done
...
# Model selection
    ...
    if ((UseGIF==1))
    then
        if [ -f ${PathID}/${PN}_GW${OptTP}/${PathGIF}/Mean*prior* ]
        then
            PriorsArray=("Out" "CSF" "CGM" "WMI" "DGM" "Brainstem")
        ...
        then
            array_PriorsToUse=(${array_PriorsGIF[*]})
            NameBrainmaskGW=${PathScratch}/${PN}_GW${OptTP}_GIF_B1.nii.gz
        elif [ -f ${PathID}/${PN}*GW${OptTP}/Priors/GIF_GM_${PN}_GW${OptTP}.nii.gz ] || [ -f ${PathID}/${PN}*${TP[0]}/${PathGIF}/*prior* ]
        then
            array_PriorsToUse=(${array_PriorsGIF[*]})
            NameBrainmaskGW=${PathScratch}/${PN}_GW${OptTP}_GIF_B1.nii.gz
        else
...
Do2=1
    if ((Do2==1))
    then
echo "ArrayMod is ${ArrayModaCode[*]} ${ArrayModaCode[0]} ${ArrayModaCode[1]}"
...
# resample SummarisedCorr into initial space
            ...
            then
                ...
                echo "${PathSeg}/seg_maths ${PathScratch}/${PN}_${TP[tp]}_GIF_TIV.nii.gz -bin -fill -odt char ${PathScratch}/${PN}_${TP[tp]}_GIF_B1.nii.gz " >> ${NameScript}
...
#                 then
#                     echo "${PathSeg}/Seg_Analysis -inTxt2 ${PathScratch}/${NameTogether}_EMfO_${PN}_${TP[tp]}_GC${OptTP}${TAOpt}${SignModa}.txt ${PathScratch}/${NameTogether}_EMfO_${PN}_${TP[tp]}_GC${OptTP}${TAOpt}${SignModa}.nii.gz -IO 1 -mask ${PathScratch}/${PN}_${TP[tp]}_GIF_B1.nii.gz ${ChangePathString}" >> ${NameScript}
#                 fi
...
#         NameSummarisedCorr=${PathScratch}/SummarisedCorrected_WS3WT1WC1JC1SP1ST1CL2CIV1_TO${NameTogether}_BiASM_${PN}_GW${OptTP}${TAOpt}${SignModa}.nii.gz
...
#             then
#                 echo "${PathReg}/reg_resample -ref ${PathScratch}/DataCorrected_${NameTogether}_EMfO_${PN}_${TP[tp]}.nii.gz -flo ${NameDataCorrectedGW} -cpp ${PathScratch}/nrr_2/*cpp*${PN}_${TP[tp]}_it2*backward*.nii.gz -res  ${PathScratch}/DataCorrected_GWto${TP[tp]}_${NameTogether}_${PN}.nii.gz " >> ${NameScript}
#             fi
...
#                     echo "${PathSeg}/Seg_Analysis -inTxt2 ${PathScratch}/${NameTogether}_EMfO_${PN}_${TP[tp]}_GC${OptTP}${TAOpt}${SignModa}.txt ${PathScratch}/${NameTogether}_EMfO_${PN}_${TP[tp]}_GC${OptTP}${TAOpt}${SignModa}.nii.gz -IO 1 -mask ${NameBrainmask} ${ChangePathString}" >> ${NameScript}
#                 fi
#                 echo "${PathSeg}/Seg_Analysis -maskMatch ${PathScratch}/I_${NameTogether}_EMfO_${PN}_${TP[tp]}_GC${OptTP}${TAOpt}.nii.gz -orderFit 1 -matchRef 1 ${PathScratch}/DataCorrected_GWto${TP[tp]}_${NameTogether}_${PN}.nii.gz -matchFloat 1 ${PathScratch}/DataCorrected_${NameTogether}_EMfO_${PN}_${TP[tp]}.nii.gz -outFit ${PathScratch}/DataCorrected_HM_GWto${TP[tp]}_${NameTogether}_${PN}.nii.gz" >> ${NameScript}
#             fi
#         fi
...
#             if [ ! -f ${PathID}/${PN}_${TP[tp]}/Results/LesionCorr*SP1ST1*_TO${NameTogether}_BiASM_${PN}_${TP[tp]}_HM${OptTP}${TAOpt}.nii.gz ]
#             then
...
then
    ...
    qsub -S /bin/bash -l hostname="!cheech*&!chong*&!lum*&!allen*" -l h_rt=30:0:0 -l h_vmem=7.9G -l tmem=7.9G -l tscratch=20G -N GlobalISBI${PN} ${NameScript}
fi
