...
${PathSeg}/seg_maths ${PathResults}/GIF_CGM_${ID}.nii.gz -add ${PathResults}/GIF_DGM_${ID}_bis.nii.gz ${PathResults}/GIF_GM_${ID}.nii.gz
    ${PathSeg}/seg_maths ${PathResults}/GIF_WMI_${ID}.nii.gz -add ${PathResults}/GIF_Brainstem_${ID}.nii.gz ${PathResults}/GIF_WM_${ID}.nii.gz
...
then
    ${PathSeg}/Seg_Analysis -inArtefact ${PathResults}/${ID}_Artefacts.nii.gz -inTxt2 ${PathResults}/${ModalitiesTot}_BiASM_${ID}_${Opt}.txt ${PathResults}/${ModalitiesTot}_BiASM_${ID}_${Opt}.nii.gz -correct -connect -inLesCorr ${PathResults}/MergedLesionSPCP_${ID}_corr.nii.gz  -mask ${PathResults}/${ID}_GIF_B1.nii.gz -inPriorsICSF ${PathResults}/ICBM_ICSF_${ID}.nii.gz -inPriorsDGM ${PathResults}/ICBM_DGM_${ID}.nii.gz -inPriorsCGM ${PathResults}/ICBM_CGM_${ID}.nii.gz -inPriorsECSF ${PathResults}/ICBM_ECSF_${ID}.nii.gz -outConnect 1 -outWM 1 -ParcellationIn ${PathResults}/GIF_Parcellation_${ID}.nii.gz  -inChangePath ${PathResults}/ -inModa 2 1 3 -WeightedSeg 3 3 1

    # ${PathSeg}/Seg_Analysis -inArtefact ${PathResults}/${ID}_Artefacts.nii.gz -inTxt2 ${PathResults}/${ModalitiesTot}_BiASM_${ID}_${Opt}.txt ${PathResults}/${ModalitiesTot}_BiASM_${ID}_${Opt}.nii.gz -correct -connect -inLesCorr ${PathResults}/SecondarySPCP_${ID}_corr.nii.gz  -mask ${PathResults}/${ID}_GIF_B1.nii.gz -inPriorsICSF ${PathResults}/ICBM_ICSF_${ID}.nii.gz -inPriorsDGM ${PathResults}/ICBM_DGM_${ID}.nii.gz -inPriorsCGM ${PathResults}/ICBM_CGM_${ID}.nii.gz -inPriorsECSF ${PathResults}/ICBM_ECSF_${ID}.nii.gz -outConnect 1 -outWM 1 -ParcellationIn ${PathResults}/GIF_Parcellation_${ID}.nii.gz  -inChangePath ${PathResults}/ -inModa 2 1 3 -WeightedSeg 3 3 1

    # ${PathSeg}/seg_maths ${PathResults}/Correct*PrimarySPCP_${ID}_corr.nii.gz -merge 1 4 ${PathResults}/Correct*SecondarySPCP_${ID}_corr.nii.gz -tmax ${PathResults}/CorrectMergedLesion_${ID}_corr.nii.gz
fi
