...
echo "echo "Reorientation to standard space of T1 image" " >> ${NameScript}
    ...
    # ${PathReg}/reg_aladin -ref ${PathScratch}/FLAIR_${ID}.nii.gz -flo ${ImageT2} -aff ${PathScratch}/Aff_T2toFLAIR.txt -res ${PathScratch}/T2_${ID}.nii.gz
    # ${PathSeg}/seg_maths ${PathScratch}/T2_${ID}.nii.gz -odt float ${PathScratch}/T2_${ID}.nii.gz
